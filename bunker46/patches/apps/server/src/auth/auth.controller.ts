...
import { PasskeyService, type PasskeyRegistrationMode } from './passkey.service.js';
...
function parsePasskeyRegistrationMode(mode?: string): PasskeyRegistrationMode {
...
export class AuthController {
  ...
  async passkeyRegisterOptions(
    ...
    return this.passkeyService.generateRegistrationOptions(
      req.user.sub,
      req.user.username,
      parsePasskeyRegistrationMode(mode),
    );
  }
