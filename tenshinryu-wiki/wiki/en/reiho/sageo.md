...
Tying Methods
Daito (大刀 l ong swords): Butterfly Knot (胡蝶結び)
...
Uses of the Sageo
One well-known use is tying it across the chest ( tasuki-gake 襷掛け ). However, this requires a Sageo of about 2 meters in length, which is just barely achievable with one jō (approximately 180 cm). Since the Sageo is not specifically designed for this purpose, it’s better to view this use as situational and pragmatic.
