---
slug: concepts/kurai/suigetsu-no-kurai
lang: el
title: Suigetsu-no-Kurai 水月の位
pair: en/concepts/kurai/suigetsu-no-kurai
tags:
- kurai
- chi
tier: chi
...
**Επίσης λέγεται:**** Yokoguruma · Kurumadachi · Hokoku / Minetani 峰谷
...
Πλήρες κείμενο: [αγγλικά](../../../en/concepts/kurai/suigetsu-no-kurai.md) · [ιαπωνικά](../../../ja/concepts/kurai/suigetsu-no-kurai.md)
